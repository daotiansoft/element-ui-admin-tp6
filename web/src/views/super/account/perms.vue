  ...
  <div v-loading="loading" class="dashboard-container">
    <div class="search-block">
      <el-form :inline="true" :model="search_form">
        ...
        <el-form-item>
          <el-input v-model="search_form.action" placeholder="搜索方法名" />
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    load_items() {
      this.loading = true
      this.$store
        .dispatch('super/perms/items', this.search_form)
        .then(res => {
    ...
    submit_add() {
      this.loading = true
      this.$store
        .dispatch('super/perms/add', this.add_form)
        .then(res => {
          this.$message({
            message: res,
            type: 'success'
    ...
    submit_edit() {
      this.loading = true
      this.$store
        .dispatch('super/perms/edit', this.edit_form)
        .then(res => {
          this.$message({
            message: res,
            type: 'success'
    ...
    del() {
      ...
      this.$confirm('此操作将永久删除选中数据, 是否继续?', '提示', {
        ...
        .then(() => {
          ...
          this.loading = true
          this.$store
            .dispatch('super/perms/del', { ids: ids })
            .then(res => {
              this.$message({
                message: res,
                type: 'success'
